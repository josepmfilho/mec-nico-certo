      ...
      <header className="sticky top-0 z-50 border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
        <nav className="container flex h-16 items-center justify-between">
          ...
          <div className="hidden items-center gap-6 md:flex">
            <Link to="/para-oficinas" className="text-sm font-medium text-foreground transition-colors">Para oficinas</Link>
            <Link to="/para-mecanicos" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Para mecânicos</Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button size="sm" asChild><Link to="/cadastro/oficina">Cadastrar</Link></Button>
          </div>
        </nav>
      </header>
